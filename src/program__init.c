...
/*   Updated: 2024/07/11 19:35:55 by capapes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline int	mx_init_program(t_program *program, \
...
static inline int	mx_init(t_program *program)
{
	return ((\
	...
	&& ((program__mx_destroy(program, MX_FULL), 1)));
}
